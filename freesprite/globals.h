...
# define M_PI           3.14159265358979323846
    ...
    #define VSP_COMPILER_VERSION std::string("clang" __clang_version__)
#elif defined(__GNUC__)
...
#elif __EMSCRIPTEN__
    #define VSP_PLATFORM VSP_PLATFORM_EMSCRIPTEN
#elif defined(VITASDK)
...
inline std::vector<BaseFilter*> g_renderFilters;
