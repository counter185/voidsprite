...
std::unordered_map<std::string, std::string> defaultVisualConfig = {
    ...
    {"launchpad/stars_color", "FFFDFFAB"},
    ...
    {"maineditor/framepicker/playpause_button/paused", Fill::Solid(0xA0000000).serialize()},
    {"maineditor/framepicker/playpause_button/playing", Fill::Gradient(0xA0909090, 0xA0000000, 0xA0909090, 0xA0000000).serialize()},
    {"maineditor/framepicker/active_frame_fill", Fill::Gradient(0x80FFFFFF, 0x80FFFFFF, 0x20FFFFFF, 0x20FFFFFF).serialize()},
    {"maineditor/framepicker/traced_frame_fill", Fill::Gradient(0x80808080, 0x80808080, 0x20000000, 0x20000000).serialize()},
    ...
    {"ui/panel/bg_unfocused_blurbehind", Fill::Gradient(0x90101010,0x90000000,0x90000000,0x90000000).serialize()},
    {"ui/panel/bg_focused_blurbehind", Fill::Gradient(0xA0101010,0xA0000000,0xA0000000,0xA0000000).serialize()},
    {"ui/scrollpanel/scrollbar_border", "40FFFFFF"},
    {"ui/scrollpanel/handle_vertical_fill", Fill::Gradient(0x40FFFFFF,0x90FFFFFF,0x40FFFFFF,0x90FFFFFF).serialize()},
    {"ui/scrollpanel/handle_horizontal_fill", Fill::Gradient(0x40FFFFFF,0x40FFFFFF,0x90FFFFFF,0x90FFFFFF).serialize()},
    {"ui/scrollpanel/handle_border", "A0FFFFFF"},
    {"actionbar/bg", Fill::Gradient(0x80000000, 0x80000000, 0x60000000, 0x60000000).serialize()},
    {"actionbar/separator", "40FFFFFF"},
    {"navbar/bg_unfocused", Fill::Solid(0x90000000).serialize()},
    {"navbar/bg_focused", Fill::Solid(0xA0000000).serialize()},
};
