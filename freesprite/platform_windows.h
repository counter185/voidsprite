...
void platformTrySaveImageFile(EventCallbackListener* listener) {
    ...
    ofna.lpstrFilter = (LPWSTR)L"PNG Files (.png)\0*.png\0voidsprite Session Files v1 (.voidsn)\0*.voidsn\0BMP Files (.bmp)\0*.bmp\0CaveStory PBM Files (.pbm)\0*.pbm\0RPG2000/2003 XYZ Files (.xyz)\0*.xyz\0All files\0*.*\0\0";
