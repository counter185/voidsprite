...
/*#if _WIN32
        ...
        g_mainlogo = ReldTexFromAsset("mainlogo.png");
        g_iconVSP32x32 = ReldTexFromAsset("icon_voidsprite32x32.png");
        g_iconFrameNew = ReldTexFromAsset("icon_frame_new.png");
        g_iconFrameDelete = ReldTexFromAsset("icon_frame_delete.png");
        g_iconFrameDuplicate = ReldTexFromAsset("icon_frame_copy.png");
        g_iconFrameMoveLeft = ReldTexFromAsset("icon_frame_moveleft.png");
        g_iconFrameMoveRight = ReldTexFromAsset("icon_frame_moveright.png");
        g_iconFramePlayPause = ReldTexFromAsset("icon_frame_playpause.png");
        g_iconLayerAdd = ReldTexFromAsset("icon_layer_add.png");
        g_iconLayerDelete = ReldTexFromAsset("icon_layer_delete.png");
        g_iconLayerUp = ReldTexFromAsset("icon_layer_up.png");
        g_iconLayerDown = ReldTexFromAsset("icon_layer_down.png");
        g_iconLayerDownMerge = ReldTexFromAsset("icon_layer_downmerge.png");
        g_iconLayerDuplicate = ReldTexFromAsset("icon_layer_duplicate.png");
        g_iconLayerHide = ReldTexFromAsset("icon_layer_hide.png");
        g_iconLayerHideOn = ReldTexFromAsset("icon_layer_hide_on.png");
        g_iconEraser = ReldTexFromAsset("icon_eraser.png");
        g_iconBlendMode = ReldTexFromAsset("icon_blendmode.png");
        g_iconColorRGB = ReldTexFromAsset("icon_color_rgb.png");
        g_iconColorHSV = ReldTexFromAsset("icon_color_hsv.png");
        g_iconColorVisual = ReldTexFromAsset("icon_color_visual.png");
        g_iconNavbarTabFile = ReldTexFromAsset("tab_file.png");
        g_iconNavbarTabEdit = ReldTexFromAsset("tab_edit.png");
        g_iconNavbarTabLayer = ReldTexFromAsset("tab_layer.png");
        g_iconNavbarTabView = ReldTexFromAsset("tab_view.png");
        g_iconComment = ReldTexFromAsset("icon_message.png");
        g_iconMenuPxDim = ReldTexFromAsset("menu_pxdim.png");
        g_iconMenuSpritesheet = ReldTexFromAsset("menu_sptl.png");
        g_iconMenuTemplates = ReldTexFromAsset("menu_templates.png");
        g_iconNotifError = ReldTexFromAsset("notif_error.png");
        g_iconNotifSuccess = ReldTexFromAsset("notif_success.png");
        g_iconNewColor = ReldTexFromAsset("icon_newcolor.png");
        g_iconActionBarUndo = ReldTexFromAsset("actionbar_undo.png");
        g_iconActionBarRedo = ReldTexFromAsset("actionbar_redo.png");
        g_iconActionBarZoomIn = ReldTexFromAsset("actionbar_zoomin.png");
        g_iconActionBarZoomOut = ReldTexFromAsset("actionbar_zoomout.png");
        g_iconActionBarSave = ReldTexFromAsset("actionbar_save.png");
        g_iconCompactColorPicker = ReldTexFromAsset("icon_compact_colorpicker.png");
        g_iconCompactToolPicker = ReldTexFromAsset("icon_compact_toolpicker.png");
        g_iconCompactLayerPicker = ReldTexFromAsset("icon_compact_layerpicker.png");
        g_iconCompactFramePicker = ReldTexFromAsset("icon_compact_framepicker.png");
