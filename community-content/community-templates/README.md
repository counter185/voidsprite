...
* The template should have distinct and easily distinguishable colours 

* The template should colour-code different segments

* The template should be annotated via the Comment tool (if you are exporting it as a .voidsn file) or with easily-readable symbols / numbers (if you are exporting as a .png). It is ideal to utilize both, which makes .voidsn the recommended export format

* The filename of the template should represent its purpose clearly (for example, RPGMaker 2003 (the engine) Chipset (what the template is for) is recommended)
