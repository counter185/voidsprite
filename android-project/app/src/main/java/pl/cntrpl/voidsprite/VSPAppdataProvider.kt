...
//thank you skyline :pray:
//(original documentsprovider was made by the skyline team,
//i adapted it to fit the voidsprite codebase)
...
class VSPAppdataProvider : DocumentsProvider() {
    ...
    override fun queryRoots(projection : Array<out String>?) : Cursor {
        ...
        cursor.newRow().apply {
            ...
            add(DocumentsContract.Root.COLUMN_ICON, R.drawable.icon_voidsprite_32x32)
        }
